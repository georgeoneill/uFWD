...
try
    ...
    % Might be an unspported forward model try calling these?
    [volp, sens] = ufwd_prepare_vol_sens(vol, sens, 'channel', D.chanlabels(chanind));
    ufwd_plot_headmodel(vol, 'edgecolor', [0 0 0], 'facealpha', 0);
end
